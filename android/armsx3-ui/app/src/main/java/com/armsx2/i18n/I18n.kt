...
val EN: Map<String, String> = mapOf(
    ...
    "cloud.providers.hint" to "Tapping a provider fills the address below — you only add your account's username and password. pCloud and Koofr have free 10 GB tiers; Nextcloud is for your own instance.",
