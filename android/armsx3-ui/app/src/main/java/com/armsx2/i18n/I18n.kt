...
val EN: Map<String, String> = mapOf(
    ...
    "cloud.pulled" to "Downloaded %d save(s).",
    "cloud.games.title" to "Cloud games",
    "cloud.games.description" to "Stream a disc image from games/ on your server, cache it, and boot it. Cached files are reused when the size matches, so re-launching is instant.",
